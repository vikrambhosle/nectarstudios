...
// Each hero text = one market segment (cycling in the hero)
const heroTexts = [
  'Our own IP. Short films & animated series built from pure creative vision.',
  'Brand videos â€” but only for brands that genuinely excite us. Nothing random.',
...
const segments = [
  {
    ...
    title: 'Original IP',
    subtitle: 'Short Films & Animated Series',
    description:
      'We build worlds we believe in â€” our own scripts, characters, and creative direction. No brief, no client, just pure vision turned into animated reality.',
  },
  {
    number: '02',
    ...
    description:
      "We don't take every job. We work with brands whose stories are worth telling â€” and we bring the same creative energy we'd give our own projects.",
  },
  {
    number: '03',
    tag: 'VFX & Animation',
    title: 'Creative Collabs',
    subtitle: 'Indie Filmmakers & Musicians',
    description:
...
const services = [
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1598153346810-860daa814c4b?auto=format&fit=crop&w=800&q=80',
  ...
  {
    title: 'VFX',
    description: "Visual wizardry that blurs the line between real and impossible. We make scenes that can't be filmed.",
...
const workSteps = [
  { step: '01', title: 'Brief', description: 'You tell us the vision. We listen â€” really listen â€” before we say a word.' },
  { step: '02', title: 'Concept', description: 'We develop a creative direction that is unexpected, honest, and distinctly ours.' },
  { step: '03', title: 'Production', description: 'Frame by frame, render by render. The magic happens here.' },
  { step: '04', title: 'Deliver', description: 'Polished, ready-to-launch content that hits different every time.' },
];
  ...
  return (
    <div className="antialiased selection:bg-[#c8f542] selection:text-[#0f1014] min-h-screen flex flex-col bg-[#0f1014] text-[#f1faee] overflow-x-hidden">
      ...
      <main className="grow relative pt-24 md:pt-32 pb-16 md:pb-24 overflow-hidden">
        <div className="bg-blob w-96 h-96 rounded-full top-0 left-[-10%] animate-blob mix-blend-screen pointer-events-none" style={{ background: '#7b6e81' }} />
        <div className="bg-blob w-96 h-96 rounded-full bottom-0 right-[-10%] animate-blob animation-delay-2000 mix-blend-screen pointer-events-none" style={{ background: '#c8f542' }} />

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">

            {/* Left â€” market-segment headlines (cycle every 6s) */}
            <div className="lg:col-span-6 flex flex-col justify-center animate-fade-in-up">
              ...
              <div className="alternating-text-container font-display text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight text-white">
                {heroTexts.map((text, idx) => (
                  <h1 key={idx} className="alt-text-anim">{text}</h1>
                ))}
              </div>
            ...
            {/* Right â€” autoplay showreel (muted, looped) */}
      ...
      {/* â”€â”€ Who We Create For â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      ...
      <section id="what-we-do" className="py-24 bg-[#c8f542] border-t border-[#b0d93c] relative z-10" aria-labelledby="services-heading">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 id="services-heading" className="font-display text-3xl md:text-4xl font-bold text-[#0f1014]">We Make Videos That Work!</h2>
      ...
      {/* â”€â”€ How We Work â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <section className="py-24 bg-[#0f1014] border-t border-gray-900 relative z-10" aria-labelledby="process-heading">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            ...
            <h2 id="process-heading" className="font-display text-3xl md:text-4xl font-bold text-white">How We Work</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 divide-y sm:divide-y-0 sm:divide-x divide-gray-800 border border-gray-800">
            {workSteps.map((s) => (
              <div key={s.step} className="p-8 group hover:bg-[#09090f] transition-colors duration-300">
                <span className="font-display text-5xl font-bold text-gray-800 group-hover:text-gray-700 transition-colors">
                  {s.step}
                </span>
                <h3 className="font-display text-xl font-bold text-white mt-4">{s.title}</h3>
                <p className="text-gray-500 text-sm mt-3 leading-relaxed">{s.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-32 bg-[#c8f542] relative z-10 overflow-hidden" aria-label="Contact">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-[#1a1b21]/70 text-lg mb-10 max-w-xl mx-auto leading-relaxed">
            Whether it&apos;s a short film, a brand video, or a wild VFX collab â€” if it excites us, we&apos;re in.
            Slide into our DMs.
          </p>
          <a
            href={INSTAGRAM_URL}
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            <div className="flex flex-col items-center md:items-start gap-2">
              <img
                ...
                height="32"
              />
              <p className="text-gray-700 text-xs">Animation Â· Stop Motion Â· VFX</p>
            </div>
